...
var forms = function forms() {
  var form = document.querySelectorAll('form'),
      ...
      result = document.querySelector('.calc-price'); // checkNumInputs('input[name="user_phone"]');
...
var showMoreStyles = function showMoreStyles(trigger, wrapper) {
  var btn = document.querySelector(trigger); // IMPLEMENTATION WITHOUT DATABASE 
  // cards.forEach(card => {
